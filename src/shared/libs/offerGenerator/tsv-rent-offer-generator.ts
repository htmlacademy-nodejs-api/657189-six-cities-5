...
import { CITIES, COLUMNS_SEPARATOR, MULTI_VALUES_SEPARATOR } from '../../constants/index.js';
import { generateRandomValue, getRandomItem, getRandomItems } from '../../helpers/index.js';
import { CityNames, Goods, HouseType, MockServerData, UserStatus } from '../../types/index.js';
...
export class TSVRentOfferGenerator implements OfferGenerator {
  ...
  generate(): string {
    ...
    const images: string = getRandomItems(mockData.images).join(MULTI_VALUES_SEPARATOR);
