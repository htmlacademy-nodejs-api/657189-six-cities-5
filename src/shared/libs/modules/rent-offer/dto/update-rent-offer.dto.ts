...
import { RENT_OFFER_ADULTS_COUNT, RENT_OFFER_BEDROOMS_COUNT, RENT_OFFER_DESCRIPTION_LENGTH, RENT_OFFER_IMAGES_COUNT, RENT_OFFER_MIN_GOODS_COUNT, RENT_OFFER_PRICE, RENT_OFFER_TITLE_LENGTH } from '../rent-offer.constants.js';
